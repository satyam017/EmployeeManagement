...
function SideBar() {
  ...
  const svg = useEffect(() => {
    if (window.localStorage.getItem("userRole") === "SUPERADMIN") {
      setSideLink([
        {
          id: 1,
          label: "Dashboard",
            ...
            <div className="-mr-1.5 flex items-center space-x-2">
              ...
              <template x-if="$store.breakpoints.smAndUp">
                ...
                >
                  ...
                  <div className="popper-root" x-ref="popperRoot">
                    <div className="popper-box flex max-h-[calc(100vh-6rem)] w-80 flex-col rounded-lg border border-slate-150 bg-white shadow-soft dark:border-navy-800 dark:bg-navy-700 dark:shadow-soft-dark">
                      <div
                        ...
                        className="is-scrollbar-hidden flex shrink-0 overflow-x-auto rounded-t-lg bg-slate-100 px-2 text-slate-600 dark:bg-navy-800 dark:text-navy-200"
                      >
