    ...
    <main>
      <div className="lg:flex">
        <div className="lg:w-1/2 xl:max-w-screen-sm">
                  ...
                  <g transform="matrix( 1, 0, 0, 1, 0,0) ">
                    <g>
                      <path
                        ...
                        className="st0"
                        d="M173.8,151.5l13.6-13.6 M35.4,89.9l29.1-29 M89.4,34.9v1 M137.4,187.9l-0.6-0.4M36.6,138.7l0.2-0.2 M56.1,169.1l27.7-27.6 M63.8,111.5l74.3-74.4 M87.1,188.1L187.6,87.6 M110.8,114.5l57.8-57.8"
                      />
                    </g>
                  </g>
                </svg>
          ...
          {/* L FORM */}
          <div className="mt-5 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-0 xl:px-24 xl:max-w-2xl">
            <h2
              className="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
                  xl:text-bold"
            >
              {loginState === 0 ? " Log in " : "Sign Up"}
            </h2>
            <div className="mt-12">
              {loginState === 0 ? <LoginForm /> : <SignUp />}
              {loginState === 0 ? (
